// @ts-nocheck
// Service Worker for Collie Flow PWA
// Offline: serve shell only. API calls (Binance) always require network.
...
self.addEventListener("fetch", (event) => {
  ...
  // Always network-first for Binance API and ICP backend — no fallback needed
  if (
