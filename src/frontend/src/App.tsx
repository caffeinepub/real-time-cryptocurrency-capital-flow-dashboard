...
import { Activity, BarChart2, Globe, Layers, TrendingUp } from "lucide-react";
...
const BubbleVisualizationTabSurface = React.lazy(
  () => import("./surfaces/BubbleVisualizationTabSurface"),
);
const CapitalFlowTabSurface = React.lazy(
  () => import("./surfaces/CapitalFlowTabSurface"),
);
const ConfluenceZonesTabSurface = React.lazy(
  () => import("./surfaces/ConfluenceZonesTabSurface"),
);
const FuturesMonitorTabSurface = React.lazy(
  () => import("./surfaces/FuturesMonitorTabSurface"),
);
