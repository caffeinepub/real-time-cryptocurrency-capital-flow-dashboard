...
export default function FuturesDashboard() {
  const { data: hasCredentials, isLoading: credentialsLoading } =
    useHasBinanceCredentials();
  const [enablePolling, _setEnablePolling] = useState(true);
    ...
    return (
      <Alert className="border-neon-yellow/30 bg-neon-yellow/5">
        ...
        <AlertDescription className="text-sm text-muted-foreground">
          Please configure your Binance API credentials above to view your
          account data.
        </AlertDescription>
      </Alert>
    );
        ...
        <Card className="terminal-panel border-neon-cyan/30 bg-card/50">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base text-neon-cyan">
                Assets & Balances
              </CardTitle>
            </div>
        ...
        <Card className="terminal-panel border-neon-green/30 bg-card/50 md:col-span-2">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-base text-neon-green">
                Open Positions
              </CardTitle>
            </div>
            <CardDescription className="text-xs">
