const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BubbleVisualization-60O_Z7eO.js","assets/index-C5QA2IZY.js","assets/index-hj3lBCcF.css","assets/useQuery-CcrFhlcP.js","assets/useActor-OERJBcGn.js","assets/index-HSqYiWTT.js","assets/trending-down-BQAueTCT.js"])))=>i.map(i=>d[i]);
import { c as createLucideIcon, a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as clsx, R as React, B as BINANCE_SPOT_REST_BASE, j as jsxRuntimeExports, u as useBinanceData, T as TrendingUp, W as WHITELISTED_SYMBOLS, _ as __vitePreload } from "./index-C5QA2IZY.js";
import { u as useQuery } from "./useQuery-CcrFhlcP.js";
import { T as TrendingDown } from "./trending-down-BQAueTCT.js";
/**
...
async function fetchKlinesWithRetry(symbol, interval = "4h", limit = 100, maxRetries = 3) {
  let lastError = null;
...
function useBinanceHistoricalData({
  symbol,
  interval = "4h",
  limit = 100,
  enabled = true
...
function useTrendChartData(symbol) {
  const {
    data: klineData,
    isLoading,
    isError,
...
function ChartContent({
  ...
  const prices = data.map((d2) => d2.close);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data, margin: { top: 2, right: 2, bottom: 2, left: 2 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: gradientId, x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: strokeColor, stopOpacity: 0.3 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: strokeColor, stopOpacity: 0 })
    ] }) }),
    showAxes && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        YAxis,
        {
          ...
          axisLine: false,
          width: 45,
          tickFormatter: (v2) => v2 >= 1e3 ? `${(v2 / 1e3).toFixed(0)}k` : v2.toFixed(2)
        }
      )
    ] }),
...
function TrendChartBySymbol({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", style: { height }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 border border-neon-green border-t-transparent rounded-full animate-spin" }) });
  }
  if (isError || !data || data.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", style: { height }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "—" }) });
  }
...
function AssetDetailCard({
  ...
  const ticker2 = tickers[tickerKey] ?? tickers[symbol];
  const price = (ticker2 == null ? void 0 : ticker2.lastPrice) ?? 0;
  const change24h = (ticker2 == null ? void 0 : ticker2.priceChangePercent) ?? 0;
  const volume = (ticker2 == null ? void 0 : ticker2.quoteVolume) ?? (ticker2 == null ? void 0 : ticker2.volume) ?? 0;
  const isPositive = change24h > 0;
  const isNegative = change24h < 0;
  const changeColor = isPositive ? "text-neon-green" : isNegative ? "text-neon-red" : "text-muted-foreground";
  const changeBg = isPositive ? "bg-neon-green/10" : isNegative ? "bg-neon-red/10" : "bg-muted/10";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-sm text-foreground", children: displaySymbol }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: displayName })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex-shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground font-mono", children: formatVolume(volume) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          TrendChart,
          {
            symbol: tickerKey,
            height: 40,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-1 mt-1 ${changeColor}`, children: [
          isPositive ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-3 h-3" }) : isNegative ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-3 h-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-medium", children: [
            isPositive ? "Alta" : isNegative ? "Baixa" : "Neutro",
            " 24h"
          ] })
        ] })
      ]
...
const BubbleVisualization = React.lazy(
  () => __vitePreload(() => import("./BubbleVisualization-60O_Z7eO.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0)
);
function SurfaceLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-2 border-neon-green border-t-transparent rounded-full animate-spin" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm", children: "Carregando visualização 3D..." })
  ] }) });
}
const TOP_SYMBOLS = [
  "BTCUSDT",
...
function LivePriceTicker() {
  const { tickers } = useBinanceData();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto scrollbar-hide", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 px-3 py-2 min-w-max", children: TOP_SYMBOLS.map((sym) => {
    const ticker2 = tickers[sym];
    const price = (ticker2 == null ? void 0 : ticker2.lastPrice) ?? 0;
    const change = (ticker2 == null ? void 0 : ticker2.priceChangePercent) ?? 0;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-foreground", children: displaySym }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-xs text-foreground", children: [
            "$",
            price >= 1e3 ? price.toLocaleString("pt-BR", { maximumFractionDigits: 0 }) : price.toLocaleString("pt-BR", {
              minimumFractionDigits: 2,
              maximumFractionDigits: 4
            })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              className: `text-[10px] font-medium ${isPos ? "text-neon-green" : isNeg ? "text-neon-red" : "text-muted-foreground"}`,
              children: [
                isPos ? "+" : "",
                change.toFixed(2),
                "%"
...
function BubbleVisualizationTabSurface() {
  const [show3D, setShow3D] = reactExports.useState(false);
  const displaySymbols = TOP_SYMBOLS.concat(
    WHITELISTED_SYMBOLS.filter((s2) => !TOP_SYMBOLS.includes(s2)).slice(0, 8)
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border/40 bg-background/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LivePriceTicker, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pt-3 pb-1 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "Visão do Mercado" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
    ...
    show3D && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "mx-3 mb-3 rounded-xl overflow-hidden border border-border/40",
        style: { height: "300px" },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(SurfaceLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(BubbleVisualization, {}) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2", children: displaySymbols.map((sym) => /* @__PURE__ */ jsxRuntimeExports.jsx(AssetDetailCard, { symbol: sym }, sym)) }) })
  ] });
}
const BubbleVisualizationTabSurface$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: BubbleVisualizationTabSurface
}, Symbol.toStringTag, { value: "Module" }));
export {
  BubbleVisualizationTabSurface$1 as B,
  TrendChart as T,
  useTrendChartData as u
};
