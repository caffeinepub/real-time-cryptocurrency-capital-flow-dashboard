    ...
    <div className="fixed inset-0 z-[100] flex items-end justify-center" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-5 mt-2">
          <img src="/assets/generated/app-icon-192.dim_192x192.png" alt="CryptoFlow" className="w-12 h-12 rounded-xl" />
          <div>
        ...
        <div className="space-y-3 mb-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Toque em Compartilhar</p>
              <p className="text-xs text-muted-foreground flex items-center gap-1">
                Toque no ícone <Share className="w-3 h-3 inline" /> na barra do Safari
              </p>
            </div>
          </div>
        ...
        <div className="bg-neon-green/5 border border-neon-green/20 rounded-xl p-3">
          <p className="text-xs text-neon-green font-medium">✓ Abre sem barra do navegador (modo standalone)</p>
